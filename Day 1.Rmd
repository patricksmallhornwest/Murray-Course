...
Git is stored in hash code (like passwords). Git makes a unique hash code and then compares it to an updated one. If the same then nothing has changed. If it's different then can update.
